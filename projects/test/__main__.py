...
from . __init__ import berry_mods
...
def main(argv):
    ...
    # for name in berry_files.values():
    #     mod = importlib.import_module(name, __path__)
    ...
    for berry_entry in berry_list:
        ...
        if berry_guid in berry_files.keys():
            berry_name = berry_files[berry_guid]
            berry_module = berry_mods[berry_name]
